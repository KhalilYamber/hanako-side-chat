// host-adapter.js —— host 行为依赖适配层（HOST_ADAPTER.md 迁移步骤 1-2）
...
// parseSessionJsonl）与「host 官方 API 封装」（createSession/readHistory/
// sendMessage，HOST_ADAPTER.md 3.1 的 host API 封装块，迁移步骤 2）。
